...
{
	[ControllerToolboxItem(Name = "PageCrud", Title = "Page Crud", SectionName = "SFAdvFeb2022")]
	public class PageCrudController : Controller, IPersonalizable
	{
		...
		public ActionResult Create()
		{
			...
			pm.Provider.SuppressSecurityChecks = true;
			...
			pm.Provider.SuppressSecurityChecks = false;
